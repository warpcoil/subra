...
static inline void *lmemcpy(LIN_ADDR t, LIN_ADDR f, size_t n)
{
	void *p1;
	void *p2;
...
//, a definition is only useful at the compile stage, not link
...
#if 0
static inline void fmemcpy(unsigned short ds,unsigned long dof,unsigned short ss,unsigned long sof,unsigned n)
{
